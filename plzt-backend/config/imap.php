    ...
    */
    'accounts' => [
        ...
        'default' => [// account identifier
            'host'  => env('IMAP_HOST', 'mail.server25.nlserver.net'),
            'port'  => env('IMAP_PORT', 143),
            'protocol'  => env('IMAP_PROTOCOL', 'imap'), //might also use imap, [pop3 or nntp (untested)]
            'encryption'    => env('IMAP_ENCRYPTION', 'starttls'), // Supported: false, 'ssl', 'tls', 'notls', 'starttls'
            'validate_cert' => env('IMAP_VALIDATE_CERT', false),
            'username' => env('IMAP_USERNAME', 'mail@animation-web.de'),
        ...
        'gmail' => [ // account identifier
            ...
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'power4its@gmail.com',
            'password' => '2SAeG:4a,edeU5uA',
