...
Nachfolgendes Todo wurde erfolgreich geprüft:<br>

Todo: {{ $todo }}<br><br>
@if($todo_status_id == 9)
Das Todo befindet sich nun in Abnahme beim Kunden. Sobald es abgenommen wurde erhältst du eine Information zur<br>
Liveschaltung.
@endif
@if($todo_status_id == 15)
Das Todo muss bis zum {{ \Carbon\Carbon::createFromFormat('Y-m-d', $deadline)->format('d.m.Y')}} live geschalten werden. Bitte informiere deinen Projektleiter, wenn<br>
die Frist nicht eingehalten werden kann.
@endif
<br><br>
