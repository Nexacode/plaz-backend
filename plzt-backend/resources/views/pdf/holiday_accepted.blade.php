...
<head>
    ...
    <style>
        ...
        .signaturepic {
            position: absolute;
            bottom: 120px; /* anpassen, um die vertikale Position der Signatur zu ändern */
        ...
        .signaturepic2 {
            position: absolute;
            bottom: 120px; /* anpassen, um die vertikale Position der Signatur zu ändern */
            left: 60px; /* anpassen, um die horizontale Position der Signatur zu ändern */
            width: 200px;
            height: 150px;
        ...
        .signature2 {
            position: absolute;
            bottom: 50px; /* anpassen, um die vertikale Position der Signatur zu ändern */
            left: 50px; /* anpassen, um die horizontale Position der Signatur zu ändern */
            width: 200px;
            height: 150px;
            border-top: 1px dotted #000;
            font-size:9px;
...
<body>
    ...
    <table class="holiday">
    	...
    	<tr>
    		<td>Tage genehmigt:</td>
    		<td>{{ $days }}</td>
    	</tr> 
    	<tr>
    		<td>Verbleibende Urlaubstage im aktuellen Jahr:</td>
    		<td>{{ $alldays - $days_approved }}</td>
    	</tr>
    	<tr>
    		<td>Urlaub genehmigt am:</td>
    		<td>{{ \Carbon\Carbon::now()->format('d.m.Y') }}</td>
    	</tr>
    </table>
    <div class="signaturepic2">
    <img src="{{ $approved_by_sig }}" alt="Signature" style="width: 200px; height: auto;">
    </div>
